...
class NotificationManager:
    ...
    def __init__(self):
        ...
        self.smptp_user = os.getenv("SMTP_MY_EMAIL")
        self.smptp_password = os.getenv("SMTP_MY_PASSWORD")
    ...
    def send_mail(self, to_address, message_body, subject_line):
         with SMTP("smtp.gmail.com", 587) as connection:
            connection.starttls()
            connection.login(user=self.smptp_user, password=self.smptp_password)
            msg = MIMEMultipart()
